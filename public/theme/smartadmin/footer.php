...
<!-- #PLUGINS -->
    ...
    <!-- CONTEXTMENU -->
    <script src="<?php echo $rutaLayout['root']; ?>public/js/menuRight/menuRight.js"></script>
    ...
    <!-- SCRIPT CROLLTABLE -->
    <script src="<?php echo $rutaLayout['root']; ?>public/js/scrollTable/scrollTable.js"></script>
    
    <!-- EXCEL FACTORY -->
    <script type="text/javascript" src="<?php echo $rutaLayout['root']; ?>public/js/excelFactory/js/require.min.js"></script>
    <script type="text/javascript" src="<?php echo $rutaLayout['root']; ?>public/js/excelFactory/js/underscore.min.js"></script>
    <script type="text/javascript" src="<?php echo $rutaLayout['root']; ?>public/js/excelFactory/js/json2.js"></script>
    <!-- <script type="text/javascript" src="<?php echo $rutaLayout['root']; ?>public/js/excelFactory/js/swfobject.js"></script> -->
    <script type="text/javascript" src="<?php echo $rutaLayout['root']; ?>public/js/excelFactory/js/downloadify.min.js"></script>
    <script type="text/javascript" src="<?php echo $rutaLayout['root']; ?>public/js/excelFactory/excelFactory.js"></script>
    
    <!-- JSPDF -->
    <script src="<?php echo $rutaLayout['root']; ?>public/js/jsPDF/jspdf.js"></script>
    <script src="<?php echo $rutaLayout['root']; ?>public/js/jsPDF/jspdf.plugin.from_html.js"></script>

    <script src="<?php echo $rutaLayout['root']; ?>public/js/jsPDF/jspdf.plugin.addimage.js"></script>
    <script src="<?php echo $rutaLayout['root']; ?>public/js/jsPDF/libs/png_support/png.js"></script>
    <script src="<?php echo $rutaLayout['root']; ?>public/js/jsPDF/libs/png_support/zlib.js"></script>
    <script src="<?php echo $rutaLayout['root']; ?>public/js/jsPDF/jspdf.plugin.png_support.js"></script>
    <script src="<?php echo $rutaLayout['root']; ?>public/js/jsPDF/jspdf.plugin.cell.js"></script>
    <script src="<?php echo $rutaLayout['root']; ?>public/js/jsPDF/jspdf.plugin.standard_fonts_metrics.js"></script>
    <script src="<?php echo $rutaLayout['root']; ?>public/js/jsPDF/jspdf.plugin.split_text_to_size.js"></script>
    <script src="<?php echo $rutaLayout['root']; ?>public/js/jsPDF/jspdf.plugin.total_pages.js"></script>
    <script src="<?php echo $rutaLayout['root']; ?>public/js/jsPDF/libs/FileSaver/FileSaver.js"></script>
    
    <?php require_once (ROOT . 'config' . DS . 'prefixJs.php'); ?>
